...
<!-- oncontextmenu="return false;" -->
	...
	<!-- Top Bar -->
  <div class="d-flex flex-lg-row flex-column justify-content-lg-around top-bar">
    <div><p class="top-bar-title" style="">ODMS Enterprise</p></div>
    <div class="">
    ...
    <div class="collapse navbar-collapse mr-md-5 mr-sm-3 " id="navbarText">
      <ul class="navbar-nav m-lg-auto ml-md-auto ml-sm-auto ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">Financial Assistance</a>
        </li>
      </ul>
