...
<div class="acceptPage container">
    <center>
        <img src="<?php echo base_url(); ?>application/assets/images/AdminPagesImages/approved.png" class="acceptImg">
        <p class="acceptHeading">You accepted the client's FA request!</p>
        <p class="acceptMsg">We rise by lifting others. An email will be sent to the client regarding your decision.</p>
